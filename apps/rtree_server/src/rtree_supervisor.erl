...
%% @doc
%%   Supervisor behaviour implementation for rtree app.
%% @copyright 2014 Carlos Roman
%% @end
%%----------------------------------------------------------------
-module(rtree_supervisor).
...
init([]) ->
    ...
    {ok, {SupFlags, [?CHILD(rtree_server_sup, supervisor),
        ?CHILD(rtree_worker_sup, supervisor)]}}.
